...
[ICs]
[./lambda_IC] type = FunctionIC variable = lambda function = 0.1*(y>0.98)  []
[]
...
#[./materialf] type = ObstacleFunctions set_g = -0.1*t+1-y set_gx = 0 set_gy = -1 set_gxx = 0 set_gxy = 0 set_gyy = 0 disp_x = disp_x disp_y = disp_y []
...
[./materialf] type = ObstacleFunctions set_g = x^2+y^2-x-2*y*(1+1)+2*1+1 set_gx = 2*x-1 set_gy = 2*y-2*(1+1) set_gxx = 2 set_gxy = 0 set_gyy = 2 disp_x = disp_x disp_y = disp_y []
