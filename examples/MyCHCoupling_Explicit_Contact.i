...
[./diffusivetimederivativeJk] type = DiffusiveTimeDerivative variable = J_k     m = 1e-8      kv = 1     J_k = J_k      mu_k = mu_k [../]
[./chempotdiff] type = ChemicalPotentialDiffusion variable = J_k     m = 1e-8      J_k = J_k       mu_k = mu_k [../]
...
[./potenziale] type = DoubleWellCH variable = mu_k coeff = 1000.0   min1 = 0.8   max = 1.02   min2 = 1.05   J_k = J_k   mu_k = mu_k [../]
[]
