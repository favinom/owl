...
[./diffusivetimederivativeJk] type = DiffusiveTimeDerivative variable = J_k     m = 1e-6      kv = 1     J_k = J_k      mu_k = mu_k [../]
[./chempotdiff] type = ChemicalPotentialDiffusion variable = J_k     m = 1e-6      J_k = J_k       mu_k = mu_k [../]

[./chempotdefinizione] type = ChemicalPotentialReaction variable = mu_k     d = 10      J_k = J_k      mu_k = mu_k [../]
